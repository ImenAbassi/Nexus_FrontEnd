...
@Component({
  selector: 'app-validation-attestation',
  templateUrl: './validation-attestation.component.html',
  styleUrls: ['./validation-attestation.component.css']
})
export class ValidationAttestationComponent {
